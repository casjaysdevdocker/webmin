...
# Docker image for webmin using the debian template
ARG IMAGE_NAME="webmin"
ARG PHP_SERVER="webmin"
ARG BUILD_DATE="202409071429"
...
ARG SERVICE_PORT="80"
ARG EXPOSE_PORTS="443 10000"
ARG PHP_VERSION="system"
ARG NODE_VERSION="system"
ARG NODE_MANAGER="system"

ARG IMAGE_REPO="casjaysdevdocker/webmin"
...
ENV HOSTNAME="casjaysdevdocker-webmin"
...
LABEL org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/webmin"
LABEL org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/webmin"
LABEL org.opencontainers.image.vcs-type="Git"
LABEL org.opencontainers.image.vcs-ref="${BUILD_VERSION}"
LABEL org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/webmin"
LABEL org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/webmin"
